  ...
  return (
    <Section id="projects">
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        {projects.map((p, i) => (
          <Reveal key={p.title} delay={Math.min(i * 100, 300)}>
            <article className="group flex h-full flex-col rounded-2xl border border-border-soft bg-surface/40 p-6 transition-all hover:-translate-y-1 hover:border-accent/40 hover:bg-surface/70">
